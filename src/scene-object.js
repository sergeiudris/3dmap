...
Object.assign(SceneObject.prototype, {
    ...
    getConcatenatedMatrix() {
        var r = this.mat4Create();
        this.mat4Multiply(this.matrix, r);
        this.goUp(function(node){
            this.mat4Multiply(node.matrix, r);
        }.bind(this))
        return r;
    },
    searchTreeUp (prop) {
